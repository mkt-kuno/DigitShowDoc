...
``400''を指定することでMilia（v4）ボードを使用します。
...
\begin{table}[htbp]
    ...
    \begin{tabular}{rlrrrr}
        ...
        Yamanin（v3） & 300 & 16 & 8 & 10 ms & App起動時GreenLEDが点灯 \\
        Milia (v4) & 400 & 16 & 8 & 10 ms & ---- \\ \bottomrule
    \end{tabular}
...
プレビュー用データ配列は、計測データを最大点数（デフォルト：4096）で保存されたものを取得できます。
